...
\section{Types of Centripetal Force} \label{11/11/2024}
	Centripetal force is not a fundemental force, rather a label given to the net force that causes an object to move in a circular path. Centripetal force can occur due to:
	\begin{itemize}
		\item Friction
