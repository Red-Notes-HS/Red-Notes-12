...
\section{New York City}
	...
	\begin{itemize}
		\item Split into 5 burrows
		\item Manhattan is the original and wealthiest part of the city
		\item Natural harbour city with access to port facilities
		\item Economic restructuring from industry to trade
		\item Land initially valuable for industry had to change in purpose
		\item Functional differentiation - Different places in the city having different purposes
			\begin{itemize}
				\item CBD
				\item Financial district
				\item Mid town
				\item Inner mixed zone
				\item Residential zone
				\item Special purpose zones - Unique separation from the city, eg. UN diplomatic zone, airports
				\item Recreational zones
...
\subsection{Challenges of living in New York}

	\begin{itemize}
		\item Transport
			\begin{itemize}
				\item Although there is a mass transit system, car usage is still high
				\item Safety
				\item Active transport
				\item Available modes of transport - eg. bike lanes
				\item Subway - Safety concerns
			\end{itemize}
		\item Housing affordability
		\item Sustainability
			\begin{itemize}
				\item Housing quality
				\item Waste management
				\item Food generation
				\item Energy sourcing
				\item High density city; limited space
			\end{itemize}
		\item Human well-being and liveability
			\begin{itemize}
				\item Employment - Minimum wage
				\item Green space
			\end{itemize}
	\end{itemize}
