...
\section{Green Polymers}
	...
	\subsection{Biodegradable Synthetic Plastics}
	
		One major issue with synthetic polymers compared to natural polymers is the fact that they are not biodegradable. This means that the plastics discarded into the environment or put into rubbish dumps are not decomposed naturally by the action of living organisms such as bacteria or fungi. Plastics comprise 4 percent by volume of landfill and, while natural polymers eventually decompose, the synthetic polymers stay around, contributing to nothing but problems in the environment.
