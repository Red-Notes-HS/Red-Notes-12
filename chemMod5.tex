...
\section{Practical Investigation 3.2}
	...
	\subsection{Materials}
		\begin{itemize}
			\item 200 mL 0.2 mol L-1 Fe(NO3)3
			\item 100 mL 0.002 mol L-1 KSCN
			\item 500 mL 0.5 mol L-1 HNO3
			\item 60 mL 0.002 mol L-1 Fe(NO3)3
	...
	\subsubsection{Part A}
		\begin{enumerate}
			...
			\item Use a 25 mL bulb pipette to transfer 25.00 mL of the 0.200 mol L-1 Fe(NO3)\item 3 to flask A.
			\item Use a graduated 10 mL pipette to transfer 1.00 mL of the 0.002 mol L-1 \item KSCN to flask A.
			...
			\item Rinse, then ¾ fill the cuvette with standard solution A and measure the absorbance with the colourimeter.
