...
\section{Emerging Coloniality of Energy Transitions in the Global South} \label{16/12/2024}
	Last 10 years, solar panel energy has become prominent in the Global South
	\subsection{SDG 7}
 		\begin{itemize}
   			\item Universal access to affodable, reliable and modern energy
      			\item Share of renewable energy to global mix
	 		\item Double energy efficiency growth
    		\end{itemize}
      	\subsection{Rural Vanuatu}
       		\begin{itemize}
	 		\item Solar panels for charging phones
    			\item Outdoor lights
       			\item Community infrastructure; community solar panels
	  	\end{itemize}
    	1.5 billion people gained access to energy in the past 15 years
     	Tonga $\rightarrow$ Centred around one urban centre, therefore can implement a grid aroud an urban centre
      	Vanuatu $\rightarrow$ 86 islands with isolated communities, hence each needs to provide its own power
